...
const (
	...
	canonicalShipVer  = "v0.6.1-helianthus.7"
...
func TestProvenanceManifestBindsUpstream(t *testing.T) {
	...
	wants := []struct{ name, got, want string }{
		...
		{"fork.intended_prerelease", manifest.Fork.IntendedPrerelease, "v0.7.1-helianthus.7"},
	...
	for _, dependency := range []struct {
		...
		{"ship", canonicalShip, canonicalShipVer, "abacdc171ffaac9b2d73eedbfe2bab6418c9028a", "9d9175e538c15e3fbbc1abd6f5f27c188c6c86e2", "3dbd8cf3dce5759b48ec3b9b42e74969a0034525", "54f91f18ab094825f68db61cad0423b4fadf2720179a09d2168d7cd988a43097"},
