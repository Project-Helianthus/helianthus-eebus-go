...
const (
	...
	productionHash    = "bf7cbcab783f8ca2962729e7c986992f5366951f8e55b3ff907bba0990c6a0c4"
)
...
func TestProvenanceManifestBindsUpstream(t *testing.T) {
	...
	wants := []struct{ name, got, want string }{
		...
		{"fork.intended_prerelease", manifest.Fork.IntendedPrerelease, "v0.7.1-helianthus.6"},
